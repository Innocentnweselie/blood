...
const Reviews = () => (
  <section className="bg-white min-h-screen py-12">
    <h2 className="text-center text-4xl font-bold mb-4 text-blue-700">
      What Our Users Say
    </h2>
    <p className="text-center font-serif mb-10">
      Hear from our satisfied users who have experienced the benefits of MedTracker in managing their medical inventory and improving patient care.
    </p>
